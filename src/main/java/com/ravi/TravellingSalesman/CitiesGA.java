...
public class CitiesGA {
    public static void main(String[] args){
        ...
        List<String> wayPoints = salesman.getWaypoints(json);
        ...
        Map<String, String> chroToPheno = salesman.getChromoToPhenoMap(wayPoints);
        Map<String, String> phenoToChron = salesman.getPhenoToChromo(wayPoints);

        BinaryGA ga = new TwoPointCrossOverGA(0.15);

        salesman.runGA(wayPoints, chroToPheno, phenoToChron, ga);

    }

    public void runGA(List<String> origWaypoints, Map<String, String> chroToPheno, Map<String, String> phenoToChron , BinaryGA ga){
    ...
    public Map<String, String> getPhenoToChromo(List<String> wayPoints){
        ...
        for(int i=0; i<wayPoints.size(); i++){
            ...
            phenoToChron.put(value,String.format("%04d", key));
        }
        return phenoToChron;
    }

    public Map<String, String> getChromoToPhenoMap(List<String> wayPoints){
        ...
        for(int i=0; i<wayPoints.size(); i++){
            ...
            chroToPheno.put(String.format("%04d", key), value);
        }

        return chroToPheno;
    }

    public List<String> getWaypoints(String json){
